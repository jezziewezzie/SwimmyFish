...
public class Start extends Group {
    ...
    public void act() {
        this.addAction(
                Actions.sequence(Actions.run(() -> sprite.setRegion(three)), Actions.fadeOut(1),

                                 Actions.run(() -> sprite.setRegion(two)), Actions.fadeIn(0),
                                 Actions.fadeOut(1),

                                 Actions.run(() -> sprite.setRegion(one)), Actions.fadeIn(0),
                                 Actions.fadeOut(1),
